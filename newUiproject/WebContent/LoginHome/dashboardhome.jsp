...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">Strategy Master</a>
        </div>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a id="dashb" href="#" class="active"><i class="fa fa-home fa-fw"></i> My Home</a>
                    </li>
                    <li>
                    ...
                    <li>
					 ...
					 <li>
                        <a href="#"><i class="fa fa-sitemap fa-fw"></i>Strategy Alert<span class="fa arrow"></span></a>
                        <ul class="nav nav-third-level">
                                    <li>
                                        <a id="MS-settings" href="#">View Alerts</a>
                                    </li>
									 <li>
                                        <a id="MS-strategy" href="#">Manage Alerts</a>
                                    </li>
